        ...
        <div className="p-8 max-w-7xl mx-auto min-h-screen bg-gray-50">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    {/* [수정] 텍스트 색상 text-gray-900 명시 */}
                    <select
                        className="px-4 py-2 border rounded-lg bg-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-gray-900 font-medium"
                    ...
                    {/* [수정] 텍스트 색상 text-gray-900 명시 */}
                    <select
                        className="px-4 py-2 border rounded-lg bg-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none disabled:bg-gray-100 text-gray-900 font-medium"
                        value={selectedYear || ""}
